    ...
    return (
        <>
            ...
            <div className="overflow-x-hidden bg-gray-50">
                ...
                <main className="mx-auto w-full max-w-4xl px-4 pb-8 pt-24 sm:px-6 lg:px-8">
                    <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-xl sm:p-10">
                        ...
                        <h1 className="mt-3 text-2xl font-black leading-tight text-gray-900 sm:text-4xl">Formulaire simple</h1>
