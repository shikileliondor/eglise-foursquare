...
export default function ShopIndex({ products }) {
    ...
    return (
        <>
            <Head title="Boutique" />
            <div className="min-h-screen overflow-x-hidden bg-[#f5f5f3] font-sans text-zinc-800">
                <PublicNavbar />

                <section className="mx-auto max-w-7xl px-4 pb-12 pt-24 sm:px-6 sm:pb-16 lg:px-8">
                    <div className="mb-10 text-center">
                        <h1 className="font-heading text-3xl font-extrabold text-zinc-700 sm:text-4xl md:text-5xl">Boutique Light</h1>
                                    ...
                                    <div className="mt-3 sm:mt-4">
                                        ...
                                        <div className="mt-2 space-y-1.5 sm:mt-3 sm:space-y-2">
                                            <button
                                                ...
                                                className="w-full rounded-full border border-zinc-400 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-zinc-700 transition hover:bg-zinc-900 hover:text-white sm:px-4 sm:py-2 sm:text-sm"
                                            >
                                                Ajouter au panier
                                            </button>
                                            ...
                                            <Link
                                                ...
                                                className="inline-flex w-full items-center justify-center rounded-full border border-zinc-300 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-zinc-600 transition hover:border-zinc-500 hover:text-zinc-900 sm:px-4 sm:py-2 sm:text-sm"
                                            >
                                                Voir panier
                                            </Link>
                                        </div>
