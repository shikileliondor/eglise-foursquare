...
const OffersCarousel = React.forwardRef(
    ({ offerIcon, offerTitle, offerSubtitle, ctaText, onCtaClick, items, className }, ref) => {
        ...
        return (
            <div ref={ref} className={cn('w-full max-w-6xl rounded-2xl border bg-card p-4 shadow-sm md:p-6', className)}>
                    ...
                    <div className="relative lg:col-span-9">
                        ...
                        {!isAtStart && (
                            <Button
                                variant="outline"
                                size="icon"
                                className="absolute left-0 top-1/2 z-10 hidden h-9 w-9 -translate-x-1/2 -translate-y-1/2 rounded-full shadow-md md:flex"
                                onClick={() => scroll('left')}
                        ...
                        {!isAtEnd && (
                            <Button
                                variant="outline"
                                size="icon"
                                className="absolute right-0 top-1/2 z-10 hidden h-9 w-9 -translate-y-1/2 translate-x-1/2 rounded-full shadow-md md:flex"
