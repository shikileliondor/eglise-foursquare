...
export default function HomePage({ products = [], latestNews = [] }) {
    ...
    return (
        <div className="min-h-screen bg-[#F7F7F5] text-[#123B68]">
            ...
            {/* HERO - Inspiration Ditto, adaptée à la Convention */}
            <section className="convention-pattern relative overflow-hidden">
                ...
                <div className="relative mx-auto grid min-h-[calc(100svh-81px)] max-w-[1580px] items-center px-5 py-5 sm:px-7 md:px-8 lg:min-h-[calc(100svh-88px)] lg:grid-cols-1 lg:px-8 lg:py-8">
                    <MotionSection delay={0.15}>
                        <div className="mx-auto flex w-full max-w-[660px] flex-col justify-center py-3 lg:max-w-[1180px] lg:items-center lg:py-0 lg:text-center">
                            ...
                            >
                                <div className="flex items-end gap-4 lg:justify-center">
                                    ...
                                    <div className="hidden min-w-[116px] -rotate-2 bg-[#225CA3] px-4 py-3.5 text-center shadow-[0_16px_32px_rgba(34,92,163,0.20)] lg:block">
                                        ...
                                        <span className="mt-1 block text-4xl font-black leading-none tracking-[-0.06em] text-white">2026</span>
                                    </div>
                                </div>
                            ...
                            <motion.div
                                ...
                                className="hero-theme-glow mx-auto mt-3.5 inline-flex w-fit flex-col items-start lg:mt-5"
                            >
                            ...
                            >
                                <a
                                    href="/communiques/convention-nationale-2026"
                                    className="hero-cta-shine inline-flex min-h-[50px] w-full items-center justify-center gap-3 rounded-xl bg-[#123B68] px-6 py-3 text-[12px] font-black text-white shadow-[0_14px_30px_rgba(34,92,163,0.24)] transition hover:-translate-y-1 hover:bg-[#225CA3] sm:w-auto lg:min-h-[52px] lg:rounded-full lg:px-8 lg:text-[13px]"
                                >
                                ...
                                >
                                    Boutique officielle <span className="text-base text-[#FBB51B]">→</span>
                                </Link>
                            </motion.div>
